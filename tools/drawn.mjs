...
const cannotDraw = {
  ...
  'snowplough-stop':             'both blades skid, and the reference blade may not',
  'backward-snowplough-stop':    'both blades skid, and the reference blade may not',
  'hockey-stop':                 'both blades skid, and the reference blade may not',
