---
name: Right backward outside double three
kind: combination
summary: RBO → RFI → RBO, back where it started — 2 turns on one foot.
...
Two three turns on one foot from a backward entry. The rhythm is the whole exercise:
