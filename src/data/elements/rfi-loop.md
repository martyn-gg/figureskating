---
name: Right forward inside loop
kind: transition
summary: RFI to RFI — a small circle traced on the same edge, still travelling forwards, and the lobe continues.
...
A loop on a forward inside edge — the same small circle, curving the other way.
