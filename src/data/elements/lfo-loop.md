---
name: Left forward outside loop
kind: transition
summary: LFO to LFO — a small circle traced on the same edge, still travelling forwards, and the lobe continues.
...
A small circle traced on one foot, on one edge, forwards, coming back to the edge
