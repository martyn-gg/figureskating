---
name: Left forward inside rocker
kind: turn
summary: LFI to LBI — half a turn into the circle, holding the edge and leaving on a new one.
...
Forwards on the inside edge, rotating into the circle, holding the inside edge out
