---
name: Left forward inside step wide
kind: transition
summary: LFI to RFI — a step onto the other foot placed wide, nothing crossing, still travelling forwards, and the lobe reverses.
entry: { foot: L, edge: I, dir: F }
turn: stepwide
prerequisites: [lfi, forward-stroking]
verified: { checked: false }
---

Forwards on an inside edge, and the free foot goes down wide: out to the side,
