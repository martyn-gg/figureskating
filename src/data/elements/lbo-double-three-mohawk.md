---
name: Left backward outside double three-mohawk
kind: combination
summary: LBO → LFI → LBO → RFO — 3 turns on two feet.
entry: { foot: L, edge: O, dir: B }
turns: [three, three, mohawk]
prerequisites: [lbo-three, lfi-three, lbo-mohawk]
verified: { checked: false }
---

Two three turns from a backward entry, then a step onto the other foot. Backwards you
