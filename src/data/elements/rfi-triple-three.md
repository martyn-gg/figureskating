---
name: Right forward inside triple three
kind: combination
summary: RFI → RBO → RFI → RBO — 3 turns on one foot.
...
Three three turns on one foot, entering forwards, with nothing in between them. Each
