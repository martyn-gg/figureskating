---
name: Right forward inside bracket-cross roll
kind: combination
summary: RFI → RBO → LBO — 2 elements on two feet.
entry: { foot: R, edge: I, dir: F }
turns: [bracket, crossroll]
prerequisites: [rfi-bracket, rbo-crossroll]
verified: { checked: false }
---

A bracket, then a rolling step onto the other foot and its outside edge. Two opposite
