---
name: Left backward outside cross roll
kind: transition
summary: LBO to RBO — a step onto the other foot, still travelling backwards, and the lobe reverses.
...
Backwards, the free foot passing the skating foot and taking its own outside edge,
