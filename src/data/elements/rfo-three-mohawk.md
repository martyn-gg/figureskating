---
name: Right forward outside three-mohawk
kind: combination
summary: RFO → RBI → LFI — 2 turns on two feet.
entry: { foot: R, edge: O, dir: F }
turns: [three, mohawk]
prerequisites: [rfo-three, rbi-mohawk]
verified: { checked: false }
---

A three turn, then straight onto the other foot. The three turn takes you from
