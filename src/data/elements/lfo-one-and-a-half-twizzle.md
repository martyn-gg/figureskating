---
name: Left forward outside 1½ twizzle
kind: twizzle
summary: LFO to LBI — 1½ rotations on one foot, travelling, one curl and no cusp.
...
One and a half rotations from a forward outside edge, leaving backwards on an
