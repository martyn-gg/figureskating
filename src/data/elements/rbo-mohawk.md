---
name: Right backward outside mohawk
kind: turn
summary: RBO to LFO — a step onto the other foot, holding the edge and staying on the same lobe. No cusp.
...
Backwards on the outside edge, stepping onto the other foot and coming out forwards
