---
name: Left forward outside rocker-counter-double twizzle
kind: combination
summary: LFO → LBO → LFO → LFO, back where it started — 3 elements on one foot.
entry: { foot: L, edge: O, dir: F }
turns: [rocker, counter, twizzle2]
prerequisites: [lfo-rocker, lbo-counter, lfo-double-twizzle]
verified: { checked: false }
---

The rocker-counter, and then two rotations on the edge it hands back. The pair returns
