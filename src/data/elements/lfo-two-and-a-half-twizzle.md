---
name: Left forward outside 2½ twizzle
kind: twizzle
summary: LFO to LBI — 2½ rotations on one foot, travelling, 2 curls and no cusp.
entry: { foot: L, edge: O, dir: F }
turn: twizzle25
prerequisites: [lfo, lfo-twizzle]
verified: { checked: false }
---

Two and a half rotations from a forward outside entry: two curls in the tracing and
