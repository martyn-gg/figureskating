---
name: Left backward inside double twizzle
kind: twizzle
summary: LBI to LBI — 2 rotations on one foot, travelling, 2 curls and no cusp.
entry: { foot: L, edge: I, dir: B }
turn: twizzle2
prerequisites: [lbi, lbi-twizzle]
verified: { checked: false }
---

Two rotations backwards on an inside edge, exiting where it began. The hardest of
