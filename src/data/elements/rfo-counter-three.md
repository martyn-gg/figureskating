---
name: Right forward outside counter-three
kind: combination
summary: RFO → RBO → RFI — 2 turns on one foot.
entry: { foot: R, edge: O, dir: F }
turns: [counter, three]
prerequisites: [rfo-counter, rbo-three]
verified: { checked: false }
---

A counter into a three turn, forwards. The counter fights the curve and changes the
