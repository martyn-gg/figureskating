---
name: Right backward inside counter-2½ twizzle
kind: combination
summary: RBI → RFI → RBO — 2 elements on one foot.
entry: { foot: R, edge: I, dir: B }
turns: [counter, twizzle25]
prerequisites: [rbi-counter, rfi-two-and-a-half-twizzle]
verified: { checked: false }
---

The pairing British Ice Skating asks for at Skills 7, from a backward inside edge and
