---
name: Right forward outside double three
kind: combination
summary: RFO → RBI → RFO, back where it started — 2 turns on one foot.
entry: { foot: R, edge: O, dir: F }
turns: [three, three]
prerequisites: [rfo-three, rbi-three]
verified: { checked: false }
---

Two three turns on the same foot, one straight after the other, entering forwards.
