---
name: Right forward inside rocker-counter-double twizzle
kind: combination
summary: RFI → RBI → RFI → RFI, back where it started — 3 elements on one foot.
entry: { foot: R, edge: I, dir: F }
turns: [rocker, counter, twizzle2]
prerequisites: [rfi-rocker, rbi-counter, rfi-double-twizzle]
