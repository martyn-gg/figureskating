---
name: Left backward outside rocker-counter-double twizzle
kind: combination
summary: LBO → LFO → LBO → LBO, back where it started — 3 elements on one foot.
entry: { foot: L, edge: O, dir: B }
turns: [rocker, counter, twizzle2]
prerequisites: [lbo-rocker, lfo-counter, lbo-double-twizzle]
verified: { checked: false }
---

A rocker into a counter into a double twizzle, from a backward entry. October 2026
