---
name: Right backward inside bracket-cross roll
kind: combination
summary: RBI → RFO → LFO — 2 elements on two feet.
entry: { foot: R, edge: I, dir: B }
turns: [bracket, crossroll]
prerequisites: [rbi-bracket, rfo-crossroll]
verified: { checked: false }
---

A bracket from a backward entry into a cross roll. It appears once in the syllabus, in
