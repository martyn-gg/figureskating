---
name: Right backward outside rocker
kind: turn
summary: RBO to RFO — half a turn into the circle, holding the edge and leaving on a new one.
...
Backwards on the outside edge — the edge you land jumps on — rotating into the
