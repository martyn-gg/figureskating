---
name: Left backward outside twizzle
kind: twizzle
summary: LBO to LBO — 1 rotation on one foot, travelling, one curl and no cusp.
...
Backwards on an outside edge, one rotation, out where it started. This is the
