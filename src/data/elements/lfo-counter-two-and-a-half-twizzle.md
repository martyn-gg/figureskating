---
name: Left forward outside counter-2½ twizzle
kind: combination
summary: LFO → LBO → LFI — 2 elements on one foot.
entry: { foot: L, edge: O, dir: F }
turns: [counter, twizzle25]
prerequisites: [lfo-counter, lbo-two-and-a-half-twizzle]
verified: { checked: false }
---

A counter and then two and a half rotations on the same foot, with no push and no new
