---
name: Left backward inside step wide
kind: transition
summary: LBI to RBI — a step onto the other foot placed wide, nothing crossing, still travelling backwards, and the lobe reverses.
...
Backwards on an inside edge, stepping wide onto the other foot's inside edge. The
