---
name: Left backward inside rocker-counter-double twizzle
kind: combination
summary: LBI → LFI → LBI → LBI, back where it started — 3 elements on one foot.
entry: { foot: L, edge: I, dir: B }
turns: [rocker, counter, twizzle2]
prerequisites: [lbi-rocker, lfi-counter, lbi-double-twizzle]
