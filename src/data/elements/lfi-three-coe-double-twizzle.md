---
name: Left forward inside 3-turn-change of edge-double twizzle
kind: combination
summary: LFI → LBO → LBI → LBI — 3 elements on one foot.
entry: { foot: L, edge: I, dir: F }
turns: [three, coe, twizzle2]
prerequisites: [lfi-three, lbo-coe, lbi-double-twizzle]
verified: { checked: false }
---

Three different things on one foot with no step anywhere in them: a three turn, then
