---
name: Left forward outside cross roll
kind: transition
summary: LFO to RFO — a step onto the other foot, still travelling forwards, and the lobe reverses.
...
The free foot swings in from the side, passes the skating foot and goes down on
