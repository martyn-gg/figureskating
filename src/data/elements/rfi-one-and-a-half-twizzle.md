---
name: Right forward inside 1½ twizzle
kind: twizzle
summary: RFI to RBO — 1½ rotations on one foot, travelling, one curl and no cusp.
entry: { foot: R, edge: I, dir: F }
turn: twizzle15
prerequisites: [rfi, rfi-twizzle]
verified: { checked: false }
---

The one British Ice Skating asks for at Skills 3: forwards on an inside edge, one
