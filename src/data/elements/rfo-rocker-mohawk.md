---
name: Right forward outside rocker-mohawk
kind: combination
summary: RFO → RBO → LFO — 2 turns on two feet.
entry: { foot: R, edge: O, dir: F }
turns: [rocker, mohawk]
prerequisites: [rfo-rocker, rbo-mohawk]
verified: { checked: false }
---

A rocker, which hands you a new circle, and then a step onto the other foot on that
