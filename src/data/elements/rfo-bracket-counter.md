---
name: Right forward outside bracket-counter
kind: combination
summary: RFO → RBI → RFI — 2 turns on one foot.
entry: { foot: R, edge: O, dir: F }
turns: [bracket, counter]
prerequisites: [rfo-bracket, rbi-counter]
verified: { checked: false }
---

A bracket into a counter, forwards. Both turn against the curve, which is what makes
