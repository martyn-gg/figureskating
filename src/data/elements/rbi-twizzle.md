---
name: Right backward inside twizzle
kind: twizzle
summary: RBI to RBI — 1 rotation on one foot, travelling, one curl and no cusp.
...
Backwards on an inside edge, one rotation, exiting on the edge it began on. The
