---
name: Left forward outside bracket
kind: turn
summary: LFO to LBI — half a turn against the circle, changing edge and staying on the same lobe.
...
The same entry as a forward outside three, the same exit edge, and the opposite
