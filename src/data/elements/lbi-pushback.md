---
name: Left backward inside push back
kind: transition
summary: LBI to RBO — a push off the inside edge onto the other foot's outside edge, still travelling backwards, and the lobe continues.
entry: { foot: L, edge: I, dir: B }
turn: pushback
aliases: [transfer of weight back]
prerequisites: [lbi, backward-stroking]
verified: { checked: false }
---

Backwards on an inside edge. The skating foot pushes against that edge and you arrive
