---
name: Right forward inside rocker-counter
kind: combination
summary: RFI → RBI → RFI, back where it started — 2 turns on one foot.
entry: { foot: R, edge: I, dir: F }
turns: [rocker, counter]
prerequisites: [rfi-rocker, rbi-counter]
verified: { checked: false }
---

A rocker into a counter, forwards. The rocker rotates into the circle and hands you
