---
name: Left forward inside rocker-counter-double twizzle
kind: combination
summary: LFI → LBI → LFI → LFI, back where it started — 3 elements on one foot.
entry: { foot: L, edge: I, dir: F }
turns: [rocker, counter, twizzle2]
prerequisites: [lfi-rocker, lbi-counter, lfi-double-twizzle]
