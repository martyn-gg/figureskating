---
name: Left backward inside three turn
kind: turn
summary: LBI to LFO — half a turn into the circle, changing edge and staying on the same lobe.
...
Backwards on the inside edge, rotating into the circle, out forwards on the outside
