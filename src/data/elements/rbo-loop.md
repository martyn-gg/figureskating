---
name: Right backward outside loop
kind: transition
summary: RBO to RBO — a small circle traced on the same edge, still travelling backwards, and the lobe continues.
...
A loop entered backwards on the outside edge. Blind, and the whole figure happens
