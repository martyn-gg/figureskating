---
name: Left forward inside three turn
kind: turn
summary: LFI to LBO — half a turn into the circle, changing edge and staying on the same lobe.
...
Forwards on the inside edge, rotating into the circle, out backwards on the outside
