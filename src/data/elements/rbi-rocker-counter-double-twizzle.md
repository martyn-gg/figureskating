---
name: Right backward inside rocker-counter-double twizzle
kind: combination
summary: RBI → RFI → RBI → RBI, back where it started — 3 elements on one foot.
entry: { foot: R, edge: I, dir: B }
turns: [rocker, counter, twizzle2]
prerequisites: [rbi-rocker, rfi-counter, rbi-double-twizzle]
