---
name: Right backward inside 3-turn-change of edge-double twizzle
kind: combination
summary: RBI → RFO → RFI → RFI — 3 elements on one foot.
entry: { foot: R, edge: I, dir: B }
turns: [three, coe, twizzle2]
prerequisites: [rbi-three, rfo-coe, rfi-double-twizzle]
verified: { checked: false }
---

A three turn, a change of edge and a double twizzle run together from a backward
