---
name: Left backward inside 3-turn-change of edge-double twizzle
kind: combination
summary: LBI → LFO → LFI → LFI — 3 elements on one foot.
entry: { foot: L, edge: I, dir: B }
turns: [three, coe, twizzle2]
prerequisites: [lbi-three, lfo-coe, lfi-double-twizzle]
