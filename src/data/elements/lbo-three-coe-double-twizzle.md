---
name: Left backward outside 3-turn-change of edge-double twizzle
kind: combination
summary: LBO → LFI → LFO → LFO — 3 elements on one foot.
entry: { foot: L, edge: O, dir: B }
turns: [three, coe, twizzle2]
prerequisites: [lbo-three, lfi-coe, lfo-double-twizzle]
