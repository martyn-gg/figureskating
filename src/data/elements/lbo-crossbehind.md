---
name: Left backward outside crossed step behind
kind: transition
summary: LBO to RBO — a step behind, with the legs crossed below the knee, still travelling backwards, and the lobe reverses.
...
Travelling backwards, with the foot going down behind the skating one on the outer edge
